...
public class BookingDatesValidator implements ConstraintValidator<ru.practicum.shareit.validator.ValidStartEndDate, Object> {
    private String startDateFieldName;
    private String endDateFieldName;

    @Override
    public void initialize(ru.practicum.shareit.validator.ValidStartEndDate annotation) {
